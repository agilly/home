...
And finally, we check out the repository that contains the firmware, which will download all essential files:
...
Then restart the Pi. The firmware will now be running as a service.
